...
- Check that: 
  ...
  - using the get file contents tool of each file created, if they are use the Edit a file in GitHub tool to edit the files relevant to creating the webpage 
